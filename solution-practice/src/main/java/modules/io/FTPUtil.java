...
public class FTPUtil {
     ...
     * FTP端口
     **/
    private static int ftpPort = 521;
    /**
     * FTP用户名
     **/
     ...
     */
    public static Map<String, Object> downLoadTableFile(String ftpPath, String savePath) {
        // 登录
    ...
    public static void main(String[] args) {
        Map<String, Object> result = FTPUtil.downLoadTableFile("dw_account_district", "C:\\Users\\messi.chaoqun.wang\\Pictures\\temp");
    }
